...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/app/page')) {
                ...
                if (preg_match('#^/admin/app/page/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_page_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_app_page_delete',));
                }
        ...
        if (preg_match('#^/(?P<url>[^/]++)?$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'show_page')), array (  'url' => '',  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',));
        }
        not_show_page:
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'show_menu');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::menuAction',  '_route' => 'show_menu',);
        }
        not_show_menu:
