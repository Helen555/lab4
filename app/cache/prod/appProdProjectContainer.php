...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.page' => 'getAdmin_PageService',
    ...
    /*
     * Gets the 'admin.page' service.
     *
     * @return \AppBundle\Admin\PageAdmin A AppBundle\Admin\PageAdmin instance.
     */
    protected function getAdmin_PageService()
    {
        $instance = new \AppBundle\Admin\PageAdmin('admin.page', 'AppBundle\\Entity\\Page', 'SonataAdminBundle:CRUD');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'web', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.page', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Панель управления' => array('label' => 'Панель управления', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'admin.page')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Page' => array(0 => 'admin.page'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.page', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'), $this);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c58f1f21fac440b7f04f9144e90b156a8a9ed4f0');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'c58f1f21fac440b7f04f9144e90b156a8a9ed4f0',
            'locale' => 'ru',
            ...
            'kernel.secret' => 'c58f1f21fac440b7f04f9144e90b156a8a9ed4f0',
